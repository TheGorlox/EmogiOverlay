...
emotion_dict= {'Angry': 0, 'Sad': 5, 'Neutral': 2, 'Disgust': 1, 'Surprise': 6, 'Fear': 4, 'Happy': 3}
emoji_array = {0: 'angerEmoji.png', 5: 'sadEmoji.png', 2: 'neutralEmoji.png', 1: 'disgustEmoji.png', 6: 'surpriseEmoji.png', 4: 'fearEmoji.png', 3: 'happyEmoji.png'}
...
def show_webcam(mirror=False):
    ...
    while True:
        ...
        for i in range(len(face_locations)):
            ...
            print(predicted_label, predicted_class) 
            ...
            # emogibuffer.append(predicted_class)
            output = cv2.resize(emogi, dsize)
